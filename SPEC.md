...
2. **Dot Marking** – Optional dot (phẩy), number indicates placement according to the original QATT instructions from the 19th century. If a "•" is preceeded the number indicates the placement in stroke order:
